...
# NOTE: REGIONS n'est plus "bloquant" car on fait un fallback automatique dans fetch_games()
REGIONS = "fr"
...
def fetch_games():
    """
    FIX 422:
    Certains plans OddsAPI n'autorisent pas certaines régions.
    On essaye plusieurs régions jusqu'à en trouver une acceptée.
    """
    if not ODDS_API_KEY:
    ...
    region_candidates = [
        "fr",     # tenté en premier (si autorisé)
        "eu",
        "uk",
        "us",
        "us2",
    ...
    for reg in region_candidates:
        ...
        try:
            ...
            # 422 = paramètres invalides / région non autorisée par ton plan
